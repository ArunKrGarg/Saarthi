...
import {Selfie, Symptoms, FarmerHome} from '@images';
            ...
            <ScrollView>
              <View>
                <DashboardItem
                  ...
                  hasDue={false}
                  onPress={() => {
                    props.navigation.navigate('ApplyLoanScreen');
                  }}
                />
                <DashboardItem
                  SvgIcon={Symptoms}
                ...
                <View
                  ...
                  <View style={{flexDirection: 'row'}}>
                    <View
                      ...
                      <H2 style={{textAlign: 'center'}}>{'Farmer World'}</H2>
                    </View>
                  </View>
                  <View style={{marginTop: hp('1')}}>
                    <FarmerHome width={wp('60')} height={wp('50')} />
                  </View>
                </View>
              </View>
            </ScrollView>
...
FarmerHomeScreen.propTypes = {};

FarmerHomeScreen.defaultProps = {};
